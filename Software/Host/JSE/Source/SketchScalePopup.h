...
class SketchScalePopup : public Component,
                         public juce::Slider::Listener,
                         public juce::Button::Listener
{
public:
    SketchScalePopup (FrameEditor* editor)
    : frameEditor (editor)
    {
        ...
        frameEditor->startTransform ("Scale Shape(s)");
    }
    ...
    void buttonClicked (juce::Button* /*buttonThatWasClicked*/) override
    {
        ...
        frameEditor->scaleSketchSelected (x / 100.0f, y / 100.0f, b, false);
    }
...
//==============================================================================
class SketchScaleButton : public PopupTool
{
public:
    SketchScaleButton (FrameEditor* editor)
    : PopupTool (editor)
    {;}
    
    std::unique_ptr<Component> makeComponent() override
    {
        return std::make_unique<SketchScalePopup>(frameEditor);
    }
};
