...
class ScalePopup : public Component,
                   public juce::Slider::Listener,
                   public juce::Button::Listener
{
public:
    ScalePopup (FrameEditor* editor)
    : frameEditor (editor)
    {
        ...
        scaleZSlider->setRange (-2000, 2000, 1);
        ...
        scaleZSlider->setTextValueSuffix ("%");
        ...
        scaleZSlider->setValue (100, dontSendNotification);
        centerButton->setToggleState (true, dontSendNotification);
        
        frameEditor->startTransform ("Scale Point(s)");
    }
    ...
    void buttonClicked (juce::Button* /*buttonThatWasClicked*/) override
    {
        ...
        frameEditor->scaleIldaSelected (x / 100.0f, y / 100.0f, z / 100.0f, b, false);
    }
...
//==============================================================================
class ScaleButton : public PopupTool
{
public:
    ScaleButton (FrameEditor* editor)
    : PopupTool (editor)
    {;}
    
    std::unique_ptr<Component> makeComponent() override
    {
        return std::make_unique<ScalePopup>(frameEditor);
    }
};
