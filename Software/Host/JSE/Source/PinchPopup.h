/*
    PinchPopup.h
    Pinch Tranform ilda Popup Controls
...
class PinchPopup : public Component,
                   public juce::Slider::Listener,
                   public juce::Button::Listener
{
public:
    PinchPopup (FrameEditor* editor)
    : frameEditor (editor)
    {
        ...
        gainSlider->setRange (0.01, 100, 0.01);
        ...
        frameEditor->startTransform ("Pinch Transform");
    }
    ...
    {
        float rad = (float)(radiusSlider->getValue());
...
//==============================================================================
class PinchButton : public PopupTool
{
public:
    PinchButton (FrameEditor* editor)
    : PopupTool (editor)
    {;}
    
    std::unique_ptr<Component> makeComponent() override
    {
        return std::make_unique<PinchPopup>(frameEditor);
    }
};
