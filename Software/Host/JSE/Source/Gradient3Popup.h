...
class Gradient3Popup : public Component,
                       public Slider::Listener,
                       public Button::Listener,
                       public ChangeListener
{
public:
    Gradient3Popup (FrameEditor* editor)
    : frameEditor (editor)
    {
        ...
        color3Button.reset (new ColourButton);
        addAndMakeVisible (color3Button.get());
        color3Button->addChangeListener (this);
        
        color3Button->setBounds (18,120,20,20);
        ...
        color1Button->setColour (TextButton::buttonColourId, Colours::red);
        color3Button->setColour (TextButton::buttonColourId, Colour (0, 255, 0));
        color2Button->setColour (TextButton::buttonColourId, Colours::blue);
        ...
        frameEditor->startTransform ("Gradient3 Effect");
    ...
    void buttonClicked (juce::Button* /*buttonThatWasClicked*/) override
    {
        ...
        Colour c3 = color3Button->findColour (TextButton::buttonColourId);
        ...
        frameEditor->gradientIldaSelected (c1, c2, angle, length, r, b, c3);
    }
...
private:
    ...
    std::unique_ptr<ColourButton> color3Button;
};

//==============================================================================
class Gradient3Button : public PopupTool
{
public:
    Gradient3Button (FrameEditor* editor)
    : PopupTool (editor)
    {;}
    
    std::unique_ptr<Component> makeComponent() override
    {
        return std::make_unique<Gradient3Popup>(frameEditor);
    }
};
