...
{
    extern const char*   anchor_png;
    const int            anchor_pngSize = 1920;

    extern const char*   anchorafter_png;
    const int            anchorafter_pngSize = 2268;

    extern const char*   anchorbefore_png;
    const int            anchorbefore_pngSize = 2264;

    extern const char*   barber_png;
    const int            barber_pngSize = 1971;

    extern const char*   bulge_png;
    const int            bulge_pngSize = 2074;

    extern const char*   cellipse_png;
    const int            cellipse_pngSize = 2172;
    ...
    extern const char*   coloradjust_png;
    const int            coloradjust_pngSize = 2114;

    extern const char*   crectangle_png;
    const int            crectangle_pngSize = 1909;
    ...
    extern const char*   path2points_png;
    const int            path2points_pngSize = 1806;
    ...
    extern const char*   render_png;
    const int            render_pngSize = 2646;
    ...
    const int            sphere_pngSize = 2201;

    extern const char*   spiral_png;
    const int            spiral_pngSize = 2089;
